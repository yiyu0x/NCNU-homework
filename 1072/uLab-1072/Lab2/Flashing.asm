...
;------------------------------------------------------------
;	Flashing.c:14: void delay(short time) {
;	-----------------------------------------
;	 function delay
;	-----------------------------------------
_delay:
...
;	Flashing.c:16: for (d1 = 0; d1 < time*100; d1 ++) {
	mov	dptr,#0x0064
	lcall	__mulint
	mov	r6,dpl
	mov	r7,dph
...
;------------------------------------------------------------
;	Flashing.c:19: void main() {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
;	Flashing.c:20: short table[] = {0x75, 0xb0};
...
;	Flashing.c:21: bool index = 0;
	mov	r7,#0x00
;	Flashing.c:22: bool flag_plus = 1;
	mov	r6,#0x01
;	Flashing.c:23: bool flag_minus = 1;
	mov	r5,#0x01
;	Flashing.c:24: while (1) {
00124$:
;	Flashing.c:26: index = !index;
	mov	a,r7
	cjne	a,#0x01,00172$
00172$:
	clr	a
	rlc	a
;	Flashing.c:27: P1 = table[index];
	mov	r7,a
	mov	r4,a
	mov	a,r4
	add	a,r4
...
;	Flashing.c:28: delay(50);
	...
	pop	ar6
	pop	ar7
;	Flashing.c:30: if (P0_0 == 0 && flag_minus) {
	jb	_P0_0,00109$
	mov	a,r5
	jz	00109$
;	Flashing.c:31: if (table[0] == 0x70 && table[1] == 0xb0) continue;
	mov	a,#0x70
...
00177$:
00102$:
;	Flashing.c:32: flag_minus = 0;
	mov	r5,#0x00
;	Flashing.c:33: table[1] -= 1;
...
;	Flashing.c:34: if (table[1] == 0xaf) {
	cjne	r3,#0xaf,00110$
	cjne	r4,#0x00,00110$
;	Flashing.c:35: table[1] = 0xb9;
	mov	((_main_table_65536_5 + 0x0002) + 0),#0xb9
	mov	((_main_table_65536_5 + 0x0002) + 1),#0x00
;	Flashing.c:36: table[0]--;
...
00180$:
	...
	sjmp	00110$
00109$:
;	Flashing.c:39: else if (P0_0 == 1) flag_minus = 1;
	jnb	_P0_0,00110$
	mov	r5,#0x01
00110$:
;	Flashing.c:41: if (P0_1 == 0 && flag_plus) {
	jb	_P0_1,00120$
	mov	a,r6
	jz	00120$
;	Flashing.c:42: if (table[0] == 0x79 && table[1] == 0xb9) continue;
	mov	a,#0x79
...
00186$:
00113$:
;	Flashing.c:43: flag_plus = 0;
	mov	r6,#0x00
;	Flashing.c:44: table[1] += 1;
	mov	a,#0x01
...
00187$:
	ljmp	00124$
00188$:
;	Flashing.c:46: table[1] = 0xb0;
	mov	((_main_table_65536_5 + 0x0002) + 0),#0xb0
	mov	((_main_table_65536_5 + 0x0002) + 1),#0x00
;	Flashing.c:47: table[0]++;
	mov	r3,(_main_table_65536_5 + 0)
	mov	r4,(_main_table_65536_5 + 1)
	inc	r3
	cjne	r3,#0x00,00189$
...
00189$:
	...
	ljmp	00124$
00120$:
;	Flashing.c:50: else if (P0_1 == 1) flag_plus = 1;
	jb	_P0_1,00190$
	ljmp	00124$
00190$:
	mov	r6,#0x01
